...
const PLATES: ReadonlyArray<Plate> = [
  {
    ...
    alt: "theClub's run sheet after a finished run — the phase spine down the left, every phase green, 01 PLAN with a single task assigned to Antigravity, and 02 EXECUTE showing the AGY worker that ran it: Gemini 3.1 Pro, CLI-native, cloud.",
    title: "The whole run, one document",
    body: "No dashboard to reassemble in your head. The phases run down the left — Analyze, Plan, Dispatch, Execute, Review, Merge, Verify, Score — and the run itself reads top to bottom. Here it's one task, planned to Antigravity and carried by AGY running Gemini 3.1 Pro, dispatched and merged clean.",
  ...
  },
  {
    ...
    alt: "The EXECUTE band's AGY worker card — a live terminal below the AGY / Gemini 3.1 Pro (High) tag, marked CLI-native and cloud, running the task 'Add src/subtract.js exporting a subtract(a, b) function.'",
    ...
    caption: "Plate 02 · execute · the worker card",
    w: 1540,
    h: 545,
    tone: "agy",
  },
